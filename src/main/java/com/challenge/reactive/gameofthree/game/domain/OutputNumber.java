...
public class OutputNumber {
    ...
    private static final String FIXED_INPUT_NUMBER = "64";
    private static final String MIN_POSSIBLE_INPUT_NUMBER = "6";
    private static final String MAX_POSSIBLE_INPUT_NUMBER = "100";
